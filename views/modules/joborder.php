...
<div class="container-fluid">
  <form class="prodfin-form" method="POST" autocomplete="nope">
    <div class="row">
      <div class="col-md-7" style="padding-left: 12px;margin-top: 13px;">
        <div class="card h-95">
          <div class="card-header d-flex bg-transparent border-bottom" style="padding-top: 12px;padding-right: 1px;padding-bottom:0;">
            <h4 class="transaction-name">JOB ORDER</h4>
              <!-- EMP ID -->
              ...
              <input type="hidden" class="form-control transaction-status" id="txt-prodstatus" name="txt-prodstatus" value="Posted" autocomplete="nope" required readonly="true">
          </div>

          <div class="card-body" style="padding-bottom: 0;margin-bottom: 0;">
              <div class="row" style="padding: 0;margin-bottom: 0;margin-top:-15px;">
              <!-- <div class="row"> -->
                ...
                <div class="col-sm-2 form-group" style="padding: 0px;padding-right: 7px;padding-left: 7px;">
                  ...
                  <input type="text" class="form-control datepicker" data-mask="99/99/9999" placeholder="Start Date&hellip;" id="date-proddate" name="date-proddate" required>
                </div> 
                
                <div class="col-sm-2 form-group" style="padding: 0px;padding-right: 7px;padding-left: 7px;">
                  <label>End Date</label>  
                  <input type="text" class="form-control datepicker" data-mask="99/99/9999" placeholder="  /  /  " id="date-proddate" name="date-proddate" required>
                </div>   
             
                <div class="col-sm-3 form-group" style="padding: 0px;">
                    <label>Trans Code</label>
                    <div class="input-group">    
                    <input type="text" class="form-control transaction-id" id="txt-prodnumber" name="txt-prodnumber" placeholder="JO #" autocomplete="nope" required readonly="true">
                    </div>
                </div>

                <div class="table-responsive" style="min-height:418px;max-height: clamp(65px,100vh,418px);overflow: auto;padding-top: 0px;margin-top:-14px;">
                  <table class="table transaction-header-product-list">
                    <thead class="sticky-top">
                      <tr>
                      <td width="65%">Item Description</td>
                        <td width="15%" style="text-align: right;">Target</td>
                        <td width="15%" style="text-align: right;">Output</td>
          ...
          <div class="card-footer" style="padding-top: 0;margin-top: 0;">
            ...
            <div class="btn-group btn-group-justified" style="margin-top: 10px;">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-light" id="btn-search" data-toggle="modal" data-target="#modal-search-prodfin"><i class="icon-file-text2"></i>&nbsp;&nbsp;Search</button>
              </div>
...
<div id="modal-search-prodfin" class="modal" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content" style="background-color: #343f53;">
      ...
      <div class="h-divider">
            ...
            <div class="col-sm-4 form-group">
              ...
              <select data-placeholder="< Select Employee >" class="form-control select-search" id="lst-empid" name="lst-empid">
                  ...
                  <?php
                    $item = null;
                    $value = null;
                    $employee = (new ControllerEmployees)->ctrFinalProductionOperators();
          ...
          <table class="table table-hover table-bordered table-striped datatable-small-font profile-grid-header prodfinTransactionTable">
          <thead>
            <tr>
              <th>Date</th>
              <th>Requestor</th>
...
<script src="views/js/joborder.js"></script>