          ...
          <div class="card-body" style="padding-bottom: 0;margin-bottom: 0;">
              ...
              <!-- <div class="row"> -->
                ...
                <div class="col-sm-3 form-group" style="padding: 0px;">
                    ...
                    <input type="text" class="form-control transaction-id" id="txt-prodnumber" name="txt-prodnumber" placeholder="Production #" autocomplete="nope" required readonly="true">
                    </div>
                </div>
...
<script src="views/js/prodfin.js"></script>