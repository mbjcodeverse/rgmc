        ...
        <div class="card h-95">
          <div class="card-header d-flex bg-transparent border-bottom" style="padding-top: 12px;padding-right: 1px;padding-bottom:10px;">
            <h4 class="card-title flex-grow-1 transaction-name">INCOMING STOCKS</h4>
              ...
              <!-- User Type -->
              <input type="hidden" name="user_type" id="user_type" value="<?php echo $_SESSION["ulevel"];?>">              
          ...
          <div class="card-body" style="padding-bottom: 0;margin-bottom: 0;">
              ...
              <!-- <div class="row"> -->
                ...
                <div class="col-sm-2 form-group" style="padding: 0px;padding-right: 7px;">
                    <input type="text" class="form-control transaction-status" id="txt-postatus" name="txt-postatus" value="Posted" autocomplete="nope" required readonly="true">
                </div>                          
            ...
            <div class="row">
             <table class="table transaction-footer">
               <tbody>
                ...
                <tr>
                  <td style="width:15%;font-size: 1.1em;padding-top: 3px;padding-bottom: 3px;text-align: right;">Receiving #</td>
                  <td style="width:30%;padding: 3px;">
                      <input type="text" class="form-control" id="tns-remarks" name="tns-remarks" autocomplete="nope" required>
                  </td>
