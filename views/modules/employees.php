      ...
      <div class="card-body">
        <div class="row">
            <div class="col-sm-4 form-group">
                ...
                <input type="text" class="form-control" id="txt-lname" name="txt-lname" autocomplete="nope" required>
            </div>

            <div class="col-sm-4 form-group">
                <label for="tns-fname">Firstname</label>
                <input type="text" class="form-control" id="tns-fname" name="tns-fname" autocomplete="nope" required>
            </div>
