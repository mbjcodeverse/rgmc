...
<div class="container-fluid">
  <form class="recycle-form" method="POST" autocomplete="nope">
    <div class="row">
      <div class="col-md-7" style="padding-left: 12px;margin-top: 13px;">
        <div class="card h-95">
          <div class="card-header d-flex bg-transparent border-bottom" style="padding-top: 12px;padding-right: 1px;padding-bottom:0;">
            <h4 class="transaction-name">RECYCLING</h4>
              <!-- EMP ID -->
          ...
          <div class="card-body" style="padding-bottom: 0;margin-bottom: 0;">
              ...
              <!-- <div class="row"> -->
                <div class="col-sm-5 form-group" style="padding: 0;">
                    <select data-placeholder="< Recycled by >" class="form-control select-search" id="sel-recycleby" name="sel-recycleby" required>
                      <option></option>
                      <?php
                        $item = null;
                        $value = null;
                ...
                <div class="col-sm-2 form-group" style="padding: 0px;padding-right: 7px;padding-left: 7px;">
                  <input type="text" class="form-control datepicker" data-mask="99/99/9999" placeholder="Pick a date&hellip;" id="date-recdate" name="date-recdate" required>
                </div>    

                <div class="col-sm-2 form-group" style="padding: 0px;padding-right: 7px;">
                    <input type="text" class="form-control transaction-status" id="txt-recstatus" name="txt-recstatus" value="Posted" autocomplete="nope" required readonly="true">
                </div>                          
             
                <div class="col-sm-3 form-group" style="padding: 0px;">
                    <div class="input-group">
                    <input type="text" class="form-control transaction-id" id="txt-recnumber" name="txt-recnumber" placeholder="Release #" autocomplete="nope" required readonly="true">
                    </div>
                </div>
          ...
          <div class="card-footer" style="padding-top: 0;margin-top: 0;">
            ...
            <div class="btn-group btn-group-justified" style="margin-top: 10px;">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-light" id="btn-search" data-toggle="modal" data-target="#modal-search-recycle"><i class="icon-file-text2"></i>&nbsp;&nbsp;Search</button>
              </div>
...
<!-- ============== Recycle List ============ -->
<div id="modal-search-recycle" class="modal" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content" style="background-color: #343f53;">
      <div class="modal-header">
        <h5 class="modal-title profile-name"><i class="icon-menu7 mr-2"></i> &nbsp;RECYCLE REQUISITION LIST</h5>
      ...
      <div class="h-divider">
          ...
          <div class="row" pb-0 style="margin:10px;margin-bottom: -20px;">
            <div class="col-sm-4 form-group">
              <label for="lst-empid" id="lbl-lst-empid" style="color:aqua;">= &gt; Recycled by</label>
              <select data-placeholder="< Select Recycler >" class="form-control select-search" id="lst-empid" name="lst-empid">
                  <option></option>
                  <?php
                    $item = null;
                    $value = null;
                    $employee = (new ControllerEmployees)->ctrRecycleOperators();
                    foreach ($employee as $key => $value) {
                      echo '<option value="'.$value["empid"].'">'.$value["lname"].', '.$value["fname"].'</option>';
                    }
                  ?>
            ...
            <div class="col-sm-2 form-group">
              <label for="lst-recstatus" id="lbl-lst-recstatus" style="color:aqua;">= &gt; Status</label>
              <select data-placeholder="< Select Status >" class="form-control select" data-fouc id="lst-recstatus" name="lst-recstatus" required>
                <option></option>
          ...
          <table class="table table-hover table-bordered table-striped datatable-small-font profile-grid-header recycleTransactionTable">
          <thead>
            <tr>
              <th>Date</th>
              <th>Recycler</th>
...
<script src="views/js/recycle.js"></script>
