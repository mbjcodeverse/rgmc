...
<div class="container-fluid">
  <form class="recycle-report-form" method="POST" autocomplete="nope">
    <div class="row">
      <div class="col-md-12" style="padding-left: 12px;margin-top: 13px;">
        <div class="card h-95">
          <div class="card-header d-flex bg-transparent border-bottom" style="padding-top: 12px;padding-right: 1px;padding-bottom:10px;">
              ...
              <h4 class="card-title flex-grow-1 transaction-name">RECYCLING</h4> 
              ...
              <div class="col-sm-3 form-group" style="padding: 0px;padding-top:8px;margin:0;">
                ...
                <select data-placeholder="< Select Type >" class="form-control select" data-container-css-class="bg-indigo-400" data-fouc id="lst-reptype" name="lst-reptype" required>  
                   ...
                   <optgroup label="GENERIC INFO">
                      <option value="1">Overall Recycle Category</option>
                      <option value="2">Category + Item Description</option>
                      <option value="3">Recycle Date Sequence Details</option>
                   <optgroup label="MACHINE SPECIFIC">   
                      <option value="4">Machine Item Recycle Summation</option>
                      <option value="5">Machine Recycle Date Trail</option>
                </select>
              </div>              
              ...
              <div class="col-sm-2 form-group" style="padding: 0px;padding-top:8px;padding-left:7px;margin:0;">
                <button type="button" class="btn btn-danger" name="btn-return" id="btn-return" style="float:right;margin-right:19px;display:none;"><i class="icon-undo"></i></button>
                <button type="button" class="btn btn-light" disabled name="btn-print-report" id="btn-print-report" style="float:right;margin-right:10px;"><i class="icon-printer"></i></button>
                <button type="button" class="btn btn-light" disabled name="btn-export" id="btn-export" style="float:right;margin-right:19px;"><i class="icon-file-spreadsheet"></i></button>
              </div>  
          </div>
          ...
          <div class="card-body" style="padding-bottom: 0;margin: 0;padding-top: 5px;">
              <div class="row" style="padding: 0;margin-bottom: 0;">
                ...
                <div class="col-sm-3 form-group">
                  ...
                  <select data-placeholder="< Select Employee >" class="form-control select-search" id="lst-postedby" name="lst-postedby">
                    ...
                    <?php
                        $item = null;
                        $value = null;
                        $employee = (new ControllerEmployees)->ctrRecycleEncoder();
                ...
                <div class="col-sm-3 form-group">
                  ...
                  <select data-placeholder="< Select Employee >" class="form-control select-search" id="lst-recycleby" name="lst-recycleby">
                    ...
                    <?php
                        $item = null;
                        $value = null;
                        $employee = (new ControllerEmployees)->ctrRecycler();
                        foreach ($employee as $key => $value) {
                          echo '<option value="'.$value["empid"].'">'.$value["lname"].', '.$value["fname"].'</option>';
                        }
                      ?>
                ...
                <div class="col-sm-1 form-group">
                  <label for="lst-recstatus">Status</label>
                  <!-- <label for="lst-recstatus" id="lbl-lst-recstatus" style="color:aqua;">= &gt; Status</label> -->
                  <select data-placeholder="< Select Status >" class="form-control select" data-fouc id="lst-recstatus" name="lst-recstatus">
                    <option></option>
...
<script src="views/js/recyclereport.js"></script>