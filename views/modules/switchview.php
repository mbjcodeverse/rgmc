        ...
        <div class="card mb-0" style="box-shadow: 4px 4px 8px 1px rgba(0, 0, 0, 0.4); border-radius: 12px;">
          <div class="card-body">
            <div class="text-center mb-4">
              ...
              <h1 class="mb-1 display-4" style="font-size: 1.5rem;">Do you want to switch view?</h1>

              <span class="text-muted d-block" style="font-size: 1.2rem; letter-spacing: 1px;">
               <?php
                    if ($_SESSION['utype'] == 'Technical'){
                        echo "MANUFACTURING APPLICATION";
                    }else{
                        echo "TECHNICAL APPLICATION";
                    }
               ?>
              </span>
            </div>
            ...
            <div class="form-group form-group-feedback form-group-feedback-left" style="display: none;">
              <input type="text" class="form-control custom-input" name="loginEmpid" id="loginEmpid" value="<?php echo isset($_SESSION['empid']) ? $_SESSION['empid'] : ''; ?>" required>
            ...
            <div class="form-group form-group-feedback form-group-feedback-left" style="display: none;">
              <input type="text" class="form-control custom-input" name="loginUtype" id="loginUtype" value="<?php echo isset($_SESSION['utype']) ? $_SESSION['utype'] : ''; ?>" required>
              <div class="form-control-feedback">
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-primary btn-block custom-btn">Toggle View <i class="icon-circle-right2 ml-2"></i></button>
            </div>
          </div>
        </div>
