...
<div class="container-fluid">
  <form class="rawout-report-form" method="POST" autocomplete="nope">
    <div class="row">
      <div class="col-md-12" style="padding-left: 12px;margin-top: 13px;">
        <div class="card h-95">
          <div class="card-header d-flex bg-transparent border-bottom" style="padding-top: 12px;padding-right: 1px;padding-bottom:10px;">
              ...
              <h4 class="card-title flex-grow-1 transaction-name">REQUISITION</h4> 
              ...
              <div class="col-sm-3 form-group" style="padding: 0px;padding-top:8px;margin:0;">
                ...
                <select data-placeholder="< Select Type >" class="form-control select" data-container-css-class="bg-indigo-400" data-fouc id="lst-reptype" name="lst-reptype" required>  
                   ...
                   <optgroup label="GENERIC INFO">
                      <option value="1">Overall Requisition Category</option>
                   ...
                   <optgroup label="MACHINE SPECIFIC">   
                      ...
                      <option value="5">Machine Requisition Date Trail</option>
                </select>
              </div>              
          ...
          <div class="card-body" style="padding-bottom: 0;margin: 0;padding-top: 5px;">
              <div class="row" style="padding: 0;margin-bottom: 0;">
                ...
                <div class="col-sm-2 form-group">
                  <label for="lst-postedby" id="lbl-lst-postedby" style="color:aqua;">= &gt; Release by</label>
                  ...
                  <select data-placeholder="< Select Employee >" class="form-control select-search" id="lst-postedby" name="lst-postedby">
                    ...
                    <?php
                        $item = null;
                        $value = null;
                        $employee = (new ControllerEmployees)->ctrRequestEncoder();
                ...
                <div class="col-sm-2 form-group">
                  <label for="lst-requestby" id="lbl-lst-requestby" style="color:aqua;">= &gt; Requested by</label>
                  
                  <select data-placeholder="< Select Employee >" class="form-control select-search" id="lst-requestby" name="lst-requestby">
                    <option></option>
                    <?php
                        $item = null;
                        $value = null;
                ...
                <div class="col-sm-1 form-group">
                  <label for="lst-reqstatus">Status</label>
                  <!-- <label for="lst-reqstatus" id="lbl-lst-reqstatus" style="color:aqua;">= &gt; Status</label> -->
                  <select data-placeholder="< Select Status >" class="form-control select" data-fouc id="lst-reqstatus" name="lst-reqstatus">
                    <option></option>
                ...
                <div class="col-sm-2 form-group">
                  <label for="lst-costype">Cost Type</label>
                  <!-- <label for="lst-reqstatus" id="lbl-lst-reqstatus" style="color:aqua;">= &gt; Status</label> -->
                  <select data-placeholder="< Select Type >" class="form-control select" data-fouc id="lst-costype" name="lst-costype">
                    <option></option>
                    <option value="Actual Cost">Actual Cost</option>
                    <option value="All Raw Materials" selected>All Raw Materials</option>
                  </select>
                </div>                
              </div>                                        
          </div>  <!-- card body -->
...
<script src="views/js/rawoutreport.js"></script>