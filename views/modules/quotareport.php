      ...
      <div class="col-md-12" style="padding-left: 12px;margin-top: 13px;">
        <div class="card h-95">
          <div class="card-header d-flex bg-transparent border-bottom" style="padding-top: 12px;padding-right: 1px;padding-bottom:10px;">
              ...
              <h4 class="card-title flex-grow-1 transaction-name">QUOTA</h4> 
              ...
              <div class="col-sm-3 form-group" style="padding: 0px;padding-top:8px;margin:0;">
                ...
                <select data-placeholder="< Select Type >" class="form-control select" data-container-css-class="bg-indigo-400" data-fouc id="lst-reptype" name="lst-reptype" required>  
                   <option></option>
                   <optgroup label="OPERATOR EFFICIENCY">   
                      <option value="1">Operator Productivity Rank</option>  
                      <option value="2">Operator Product Category Efficiency</option>  
                   <optgroup label="MACHINE EFFICIENCY">   
                      <option value="3">Machine Productivity Rank</option>  
                      <option value="4">Machine Category Efficiency</option>  
                      <option value="5">Machine Production Performance</option>  
                </select>
              </div>              
          ...
          <div class="card-body" style="padding-bottom: 0;margin: 0;padding-top: 5px;">
              <div class="row" style="padding: 0;margin-bottom: 0;">
                ...
                <div class="col-sm-2 form-group">
                  <label for="lst-etype" id="lbl-lst-etype" style="color:aqua;">= &gt; Entry Type</label>
                  <select data-placeholder="< Select Type >" class="form-control select" data-fouc id="lst-etype" name="lst-etype">
                    <option></option>
...
<script src="views/js/quotareport.js"></script>