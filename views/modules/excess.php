...
<div class="container-fluid">
  <form class="excess-form" method="POST" autocomplete="nope">
    <div class="row">
      <div class="col-md-7" style="padding-left: 12px;margin-top: 13px;">
        <div class="card h-95">
          <div class="card-header d-flex bg-transparent border-bottom" style="padding-top: 12px;padding-right: 1px;padding-bottom:0;">
            <h4 class="transaction-name">EXCESS</h4>
              <!-- EMP ID -->
          ...
          <div class="card-body" style="padding-bottom: 0;margin-bottom: 0;">
              ...
              <!-- <div class="row"> -->
                ...
                <div class="col-sm-2 form-group" style="padding: 0px;padding-right: 7px;padding-left: 7px;">
                  <input type="text" class="form-control datepicker" data-mask="99/99/9999" placeholder="Pick a date&hellip;" id="date-excdate" name="date-excdate" required>
                </div>    

                <div class="col-sm-2 form-group" style="padding: 0px;padding-right: 7px;">
                    <input type="text" class="form-control transaction-status" id="txt-excstatus" name="txt-excstatus" value="Posted" autocomplete="nope" required readonly="true">
                </div>                          
             
                <div class="col-sm-3 form-group" style="padding: 0px;">
                    <div class="input-group">
                    <input type="text" class="form-control transaction-id" id="txt-excnumber" name="txt-excnumber" placeholder="Excess #" autocomplete="nope" required readonly="true">
                    </div>
                </div>
          ...
          <div class="card-footer" style="padding-top: 0;margin-top: 0;">
            ...
            <div class="btn-group btn-group-justified" style="margin-top: 10px;">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-light" id="btn-search" data-toggle="modal" data-target="#modal-search-excess"><i class="icon-file-text2"></i>&nbsp;&nbsp;Search</button>
              </div>
...
<!-- ============== Excess Materials List ============ -->
<div id="modal-search-excess" class="modal" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content" style="background-color: #343f53;">
      <div class="modal-header">
        <h5 class="modal-title profile-name"><i class="icon-menu7 mr-2"></i> &nbsp;EXCESS MATERIALS LIST</h5>
      ...
      <div class="h-divider">
          ...
          <div class="row" pb-0 style="margin:10px;margin-bottom: -20px;">
            ...
            <div class="col-sm-2 form-group">
              ...
              <select data-placeholder="< Select Status >" class="form-control select" data-fouc id="lst-excstatus" name="lst-excstatus" required>
                <option></option>
          ...
          <table class="table table-hover table-bordered table-striped datatable-small-font profile-grid-header excessTransactionTable">
          <thead>
            <tr>
              <th>Date</th>
              <th>Operated by</th>
...
<script src="views/js/excess.js"></script>
