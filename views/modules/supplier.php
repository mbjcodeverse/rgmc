      ...
      <div class="card-body">
        <div class="row">
            <div class="col-sm-5 form-group">
                ...
                <input type="text" class="form-control text-capitalize bordered-textbox" id="tns-name" name="tns-name" autocomplete="nope" required>
            </div>

            <div class="col-sm-4 form-group">
                <label for="tns-contactperson">Contact Person</label>
                <input type="text" class="form-control text-capitalize bordered-textbox" id="tns-contactperson" name="tns-contactperson" autocomplete="nope">
            </div>                                           
            ...
            <div class="col-sm-2 form-group">
                ...
                <input type="text" class="form-control profile-code bordered-textbox" id="txt-suppliercode" name="txt-suppliercode" autocomplete="nope" required readonly="true">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-9 form-group">
                ...
                <input type="text" class="form-control bordered-textbox" id="tns-address" name="tns-address" autocomplete="nope">
            </div>

            <div class="col-sm-3 form-group">
              <label for="sel-country">Country</label>
              <select class="form-control select-search" data-container-css-class="border-secondary" data-dropdown-css-class="border-secondary" id="sel-country" name="sel-country">
        ...
        <div class="row">
            <div class="col-sm-2 form-group">
                ...
                <input type="text" class="form-control bordered-textbox" id="tns-tin" name="tns-tin" autocomplete="nope">
            </div> 

            <div class="col-sm-2 form-group">
              <label for="sel-vatdesc" id="lbl-sel-vatdesc">VAT Desc</label>
              <select data-placeholder="Select Desc" class="form-control select" data-container-css-class="border-secondary" data-dropdown-css-class="border-secondary" data-fouc id="sel-vatdesc" name="sel-vatdesc">
                <option></option>
            ...
            <div class="col-sm-8 form-group">
                <label for="tns-description">Remarks</label>
                <input type="text" class="form-control bordered-textbox" id="tns-description" name="tns-description" autocomplete="nope">
            </div>                              
        </div>

        <div class="row">
            <div class="col-sm-3 form-group">
                <label for="tns-mobile">Mobile#</label>
                <input type="text" class="form-control bordered-textbox" id="tns-mobile" name="tns-mobile" autocomplete="nope">
            </div>
            <div class="col-sm-3 form-group">
                <label for="tns-landline">Landline #</label>
                <input type="text" class="form-control bordered-textbox" id="tns-landline" name="tns-landline" autocomplete="nope">
            </div>  
            <div class="col-sm-3 form-group">
                <label for="tns-faxnum">Fax #</label>
                <input type="text" class="form-control bordered-textbox" id="tns-faxnum" name="tns-faxnum" autocomplete="nope">
            </div>                                            
            <div class="col-sm-3 form-group">
                <label for="tns-website">Website</label>
                <input type="text" class="form-control bordered-textbox" id="tns-website" name="tns-website" autocomplete="nope">
            </div>
        </div> 
        <div class="clearfix">
