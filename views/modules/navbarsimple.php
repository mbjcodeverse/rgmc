  ...
  <div class="navbar navbar-expand-md navbar-light fixed-top">
    <div>
      <!-- <a href="index.html" class="d-inline-block"> -->
        <img src="views/global_assets/images/rivsonlogo.png" alt="">
      <!-- </a> -->
    </div>
...
<!--       <ul class="navbar-nav">
      ...
      <h2 class="card-title my-3 my-md-0 ml-md-3 mr-md-auto" style="color:gold;font-size: 1.5em;">RIVSON GOLDPLAST MANUFACTURING CORP</h2>


      <ul class="navbar-nav">
        <p style="padding-top: 14px;padding-right: 14px;color:#fff2fe;font-size: 1.3em;" id="current_date"></p>
        <p style="padding-top: 14px;padding-right: 14px;color:#fff2fe;font-size: 1.3em;" id="current_time"></p>
                ...
                <li class="media">
                  ...
                  <div class="media-body">
                    <div class="media-title">
                      <a href="#">
                        <span class="font-weight-semibold text-white">Adrian Joshua R. Lamata</span>
