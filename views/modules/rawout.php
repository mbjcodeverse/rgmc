...
<div class="container-fluid">
  <form class="rawout-form" method="POST" autocomplete="nope">
    <div class="row">
      <div class="col-md-7" style="padding-left: 12px;margin-top: 13px;">
        <div class="card h-95">
          <div class="card-header d-flex bg-transparent border-bottom" style="padding-top: 12px;padding-right: 1px;padding-bottom:0;">
            <h4 class="transaction-name">REQUISITION</h4>
              <!-- EMP ID -->
          ...
          <div class="card-body" style="padding-bottom: 0;margin-bottom: 0;">
              ...
              <!-- <div class="row"> -->
                ...
                <div class="col-sm-3 form-group" style="padding: 0px;">
                    ...
                    <input type="text" class="form-control transaction-id" id="txt-reqnumber" name="txt-reqnumber" placeholder="Release #" autocomplete="nope" required readonly="true">
                    </div>
                </div>
                  ...
                  <table class="table transaction-header-product-list">
                    <thead class="sticky-top">
                      <tr>
                        ...
                        <td width="10%" style="text-align: right;">MC</td>
          ...
          <div class="card-footer" style="padding-top: 0;margin-top: 0;">
            ...
            <div class="btn-group btn-group-justified" style="margin-top: 10px;">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-light" id="btn-search" data-toggle="modal" data-target="#modal-search-rawout"><i class="icon-file-text2"></i>&nbsp;&nbsp;Search</button>
              </div>
...
<!-- ============== Raw Material Releasing List ============ -->
<div id="modal-search-rawout" class="modal" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content" style="background-color: #343f53;">
      <div class="modal-header">
        <h5 class="modal-title profile-name"><i class="icon-menu7 mr-2"></i> &nbsp;RAW MATERIAL REQUISITION LIST</h5>
      ...
      <div class="h-divider">
          ...
          <table class="table table-hover table-bordered table-striped datatable-small-font profile-grid-header rawoutTransactionTable">
          <thead>
            <tr>
              <th>Date</th>
              <th>Requestor</th>
...
<script src="views/js/rawout.js"></script>
