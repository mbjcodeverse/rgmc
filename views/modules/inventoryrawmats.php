...
<div class="container-fluid">
  <form class="inventoryrawmat-form" method="POST" autocomplete="nope">
    <div class="row">
      <div class="col-md-7" style="padding-left: 12px;margin-top: 13px;">
        <div class="card h-95">
          <div class="card-header d-flex bg-transparent border-bottom" style="padding-top: 12px;padding-right: 1px;padding-bottom:0;">
            <h4 class="transaction-name">RAW MATERIALS PHYSICAL INVENTORY</h4>
              <!-- EMP ID -->
          ...
          <div class="card-body" style="padding-bottom: 0;margin-bottom: 0;">
              ...
              <!-- <div class="row"> -->
                <div class="col-sm-5 form-group" style="padding: 0;">
                    <select data-placeholder="< Counted by >" class="form-control select-search" id="sel-countedby" name="sel-countedby" required>
                      <option></option>
                      <?php
                        $item = null;
                        $value = null;
                ...
                <div class="col-sm-3 form-group" style="padding: 0px;">
                    ...
                    <input type="text" class="form-control transaction-id" id="txt-invnumber" name="txt-invnumber" placeholder="Inv #" autocomplete="nope" required readonly="true">
                    </div>
                </div>
          ...
          <div class="card-footer" style="padding-top: 0;margin-top: 0;">
               ...
               <tbody>
                <tr>
                  ...
                  <td style="width:20%;padding: 3px;">
                      <input type="text" class="form-control" id="tns-search" name="tns-search" placeholder="Search Product . . ." autocomplete="nope" disabled>
                  </td>
                </tr>                
            ...
            <div class="btn-group btn-group-justified" style="margin-top: 10px;">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-light" id="btn-search" data-toggle="modal" data-target="#modal-search-inventoryrawmat"><i class="icon-file-text2"></i>&nbsp;&nbsp;Search</button>
              </div>
...
<div id="modal-search-inventoryrawmat" class="modal" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content" style="background-color: #343f53;">
      <div class="modal-header">
        <h5 class="modal-title profile-name"><i class="icon-menu7 mr-2"></i> &nbsp;RAW MATERIALS INVENTORY LIST</h5>
      ...
      <div class="h-divider">
          ...
          <div class="row" pb-0 style="margin:10px;margin-bottom: -20px;">
            <div class="col-sm-4 form-group">
              <label for="lst-empid" id="lbl-lst-empid" style="color:aqua;">= &gt; Counted by</label>
            ...
            <div class="col-sm-2 form-group">
              <label for="lst-invstatus" id="lbl-lst-invstatus" style="color:aqua;">= &gt; Status</label>
              <select data-placeholder="< Select Status >" class="form-control select" data-fouc id="lst-invstatus" name="lst-invstatus" required>
                <option></option>
          ...
          <table class="table table-hover table-bordered table-striped datatable-small-font profile-grid-header inventoryrawmatTransactionTable">
          <thead>
            <tr>
              <th>Date</th>
              <th>Counted by</th>
...
<script src="views/js/inventoryrawmats.js"></script>
