      ...
      <div class="col-md-7" style="padding-left: 12px;margin-top: 13px;">
        <div class="card h-95">
          <div class="card-header d-flex bg-transparent border-bottom" style="padding-top: 12px;padding-right: 1px;padding-bottom:0;">
            <h4 class="transaction-name">PRODUCTS</h4>
              <!-- EMP ID -->
              ...
              <input type="text" class="form-control transaction-id" id="txt-debstatus" name="txt-debstatus" placeholder="Release #" autocomplete="nope" required readonly="true">
          ...
          <div class="card-body" style="padding-bottom: 0;margin-bottom: 0;margin-top:-15px;">
              ...
              <!-- <div class="row"> -->
                ...
                <div class="table-responsive" style="min-height:218px;max-height: clamp(65px,100vh,218px);overflow: auto;padding-top: 0px;margin-top:-15px;">
                ...
                <!-- ******* Waste list ******* -->
                <div class="table-responsive" style="min-height:179px;max-height: clamp(65px,100vh,179px);overflow: auto;padding-top: 0px;margin-top:-15px;">
                  <table class="table transaction-header-product-list">
                    <thead class="sticky-top">
                      <tr>
                      <td width="50%">Waste Description</td>
                        <td width="15%" style="text-align: right;">Qty</td>
                        <td width="15%" style="text-align: right;">Unit Cost</td>
                        <td width="15%" style="text-align: right;">Amount</td>
                        <!-- <td width="80%">Item Description</td>
...
<script src="views/js/prodwaste.js"></script>