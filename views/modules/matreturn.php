...
<div class="container-fluid">
  <form class="matreturn-form" method="POST" autocomplete="nope">
    <div class="row">
      <div class="col-md-7" style="padding-left: 12px;margin-top: 13px;">
        <div class="card h-95">
          <div class="card-header d-flex bg-transparent border-bottom" style="padding-top: 12px;padding-right: 1px;padding-bottom:0;">
            <h4 class="transaction-name">RETURN</h4>
              <!-- EMP ID -->
              ...
              <div class="col-sm-3 form-group" style="padding: 0px;padding-top:8px;padding-right:10px;margin:0;margin-left:-90px;">
                <select data-placeholder="Return Type" class="form-control select" data-fouc id="sel-returntype" name="sel-returntype" required>
                  <option></option>
                  <option value="Return to Inventory">Return to Inventory</option>
                  <option value="Return to Cost">Return to Cost</option>
                </select>
              </div>              
          ...
          <div class="card-body" style="padding-bottom: 0;margin-bottom: 0;">
              ...
              <!-- <div class="row"> -->
                <div class="col-sm-5 form-group" style="padding: 0;">
                    <select data-placeholder="< Returned by >" class="form-control select-search" id="sel-returnby" name="sel-returnby" required>
                      <option></option>
                      <?php
                        $item = null;
                        $value = null;
                ...
                <div class="col-sm-3 form-group" style="padding: 0px;">
                    ...
                    <input type="text" class="form-control transaction-id" id="txt-retnumber" name="txt-retnumber" placeholder="Release #" autocomplete="nope" required readonly="true">
                    </div>
                </div>
          ...
          <div class="card-footer" style="padding-top: 0;margin-top: 0;">
            ...
            <div class="btn-group btn-group-justified" style="margin-top: 10px;">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-light" id="btn-search" data-toggle="modal" data-target="#modal-search-matreturn"><i class="icon-file-text2"></i>&nbsp;&nbsp;Search</button>
              </div>
...
<div id="modal-search-matreturn" class="modal" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content" style="background-color: #343f53;">
      <div class="modal-header">
        <h5 class="modal-title profile-name"><i class="icon-menu7 mr-2"></i> &nbsp;MATERIAL RETURN LIST</h5>
      ...
      <div class="h-divider">
          ...
          <div class="row" pb-0 style="margin:10px;margin-bottom: -20px;">
            <div class="col-sm-2 form-group">
              <label for="lst-returntype" id="lbl-lst-returntype">Return Type</label>
              <select data-placeholder="< Select Type >" class="form-control select" data-fouc id="lst-returntype" name="lst-returntype" required>
                  <option></option>
                  <option value="Return to Inventory" selected>Return to Inventory</option>
                  <option value="Return to Cost">Return to Cost</option>
              </select>
            </div> 

            <div class="col-sm-2 form-group">
              <label for="lst-empid" id="lbl-lst-empid" style="color:aqua;">= &gt; Returned by</label>
            ...
            <div class="col-sm-2 form-group">
              ...
              <select data-placeholder="< Select Status >" class="form-control select" data-fouc id="lst-retstatus" name="lst-retstatus" required>
                <option></option>
          ...
          <table class="table table-hover table-bordered table-striped datatable-small-font profile-grid-header matreturnTransactionTable">
          <thead>
            <tr>
              <th>Date</th>
              <th>Returned by</th>
...
<script src="views/js/matreturn.js"></script>
