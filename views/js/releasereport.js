$(function() {
    $('#lst_date_range').daterangepicker({
     ...
     $("#lbl-lst-deptcode").click(function(){
        $("#lst-deptcode").val('').trigger('change');
     });      
     ...
     $('#lst-machineid, #lst_date_range, #lst-deptcode, #lst-categorycode, #lst-postedby, #lst-requestby, #lst-reqstatus, #lst-reptype').on("change", function(){
        ...
        $.ajax({
             url:"ajax/release_report.ajax.php",   
             method: "POST",                
             data: data,                    
             cache: false,                  
             contentType: false,            
