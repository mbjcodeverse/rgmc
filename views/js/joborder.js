        ...
        success:function(answer){
          ...
          var price = numberWithCommas(price_amount);
           ...
           $(".enlisted_products").append(
            ...
            '<td class="priceEntry" width="15%" style="padding:2px;">'+
                '<input type="text" style="padding:2px;padding-right:17px;text-align:right;color:transparent;text-shadow: 0 0 0 #ffffff;" class="form-control price numeric" itemid="'+itemid+'" name="price" value="0.00" required>'+
            '</td>' +   
          '</tr>')
