$(function() {
   ...
   // $('#form-category-rawmats input[id^="txt"]').on("keypress", function (e) {
   ...
   $('.categoryRawMatsTable tbody').on('dblclick', 'tr', function () {
	  var idCategory = $(this).attr("idCategory");
	  var data = new FormData();
      data.append("idCategory", idCategory);
      $.ajax({
     	 url:"ajax/get_category_rawmats_record.ajax.php",
      	 method: "POST",
      	 data: data,
      	 cache: false,
      	 contentType: false,
      	 ...
      	 success:function(answer){
            ...
            $("#modal-search-category-rawmats").modal('hide');
      	}
      })
   }); 
});
