...
//    $('#form-category-goods input[id^="txt"]').on("keypress", function (e) {
...
//    });  
   ...
   $('.categoryGoodsTable tbody').on('dblclick', 'tr', function () {
	  var idCategory = $(this).attr("idCategory");
	  var data = new FormData();
      data.append("idCategory", idCategory);
      $.ajax({
     	 url:"ajax/get_category_goods_record.ajax.php",
      	 method: "POST",
      	 data: data,
      	 cache: false,
      	 contentType: false,
      	 ...
      	 success:function(answer){
            ...
            $("#modal-search-category-goods").modal('hide');
      	}
      })
   }); 
});
