$(function() {
     ...
     $("#lbl-lst-requestby").click(function(){
        $("#lst-requestby").val('').trigger('change');
     });     
     ...
     $('#lst-machineid, #lst_date_range, #lst-categorycode, #lst-postedby, #lst-requestby, #lst-reqstatus, #lst-reptype, #lst-costype').on("change", function(){
        ...
        data.append("costype", costype);
  
        $.ajax({
             url:"ajax/rawout_report.ajax.php",   
             method: "POST",                
             data: data,                    
             cache: false,                  
             contentType: false,            
                      ...
                      html.push('<div class="table-responsive" style="overflow-y: auto; max-height: 470px;">');
                        html.push('<table class="table mx-auto w-auto">');
                          ...
                          html.push('<tr>');
                            ...
                            html.push('<th class="table_head_left_fixed" style="padding-top:8px;padding-bottom:8px;">Releaser</th>');
                            html.push('<th class="table_head_left_fixed" style="padding-top:8px;padding-bottom:8px;">Requestor</th>');
                            html.push('<th class="table_head_left_fixed" style="padding-top:8px;padding-bottom:8px;">Items</th>');
                            html.push('<th class="table_head_right_fixed" style="padding-top:8px;padding-bottom:8px;">Qty</th>');
                          ...
                          for(var i = 0; i < answer.length; i++) {
                              ...
                              var rel_date = release.reqdate;
                              var reqdate = rel_date.substring(5, 7) + '/' + rel_date.substring(8, 10) + '/' + rel_date.substring(0, 4);
  
                              var reqnumber = release.reqnumber;
                              var machabbr = release.machabbr;
                              var machinedesc = release.machinedesc;
                              var reqstatus = release.reqstatus;
                              ...
                              if (prodname == null){
                                ...
                                if (i == 0){
                                  var prev_reqnumber = release.reqnumber;
                                  var prev_reqdate = release.reqdate;
                                }else{
                                  var curr_reqnumber = release.reqnumber;
                                  ...
                                  var prev_reqnumber = curr_reqnumber;
                                  // don't display same date
                                  var curr_reqdate = release.reqdate;
                                  if (prev_reqdate == curr_reqdate){
                                    reqdate = '';
                                  }
                                  var prev_reqdate = curr_reqdate;                    
                                }                 
                              }
  
                              html.push('<tr>');
                                html.push('<td>'+reqdate+'</td>');
  
                                if (reqstatus == 'Void'){
                                  html.push('<td style="color:orange;">'+reqnumber+'</td>');
                                }else{
                                  html.push('<td>'+reqnumber+'</td>');
                                }
                    ...
                    html.push('<div class="table-responsive" style="overflow-y: auto; max-height: 470px;">');
                        html.push('<table class="table mx-auto w-auto">');
                          ...
                          html.push('<tr>');
                            html.push('<th class="table_head_left_fixed" style="padding-top:8px;padding-bottom:8px;">Machine</th>');
                            html.push('<th class="table_head_left_fixed" style="padding-top:8px;padding-bottom:8px;">Date</th>');
                            html.push('<th class="table_head_left_fixed" style="padding-top:8px;padding-bottom:8px;">Req #</th>');
                            html.push('<th class="table_head_left_fixed" style="padding-top:8px;padding-bottom:8px;">Posted by</th>');
                            html.push('<th class="table_head_left_fixed" style="padding-top:8px;padding-bottom:8px;">Requested by</th>');
                            html.push('<th class="table_head_left_fixed" style="padding-top:8px;padding-bottom:8px;">Items</th>');
                            html.push('<th class="table_head_right_fixed" style="padding-top:8px;padding-bottom:8px;">Qty</th>');
                            html.push('<th class="table_head_right_fixed" style="padding-top:8px;padding-bottom:8px;">Cost</th>');
                            html.push('<th class="table_head_right_fixed" style="padding-top:8px;padding-bottom:8px;">Amount</th>');
                          ...
                          for(var i = 0; i < answer.length; i++) {
                              ...
                              var req_date = release.reqdate;
                              var reqdate = req_date.substring(5, 7) + '/' + req_date.substring(8, 10) + '/' + req_date.substring(0, 4);
     ...
     $("#btn-print-report").click(function(){
       ...
       window.open("extensions/tcpdf/pdf/rawoutprint.php?reptype="+reptype+"&machineid="+machineid+"&start_date="+start_date+"&end_date="+end_date+"&categorycode="+categorycode+"&postedby="+postedby+"&requestby="+requestby+"&reqstatus="+reqstatus+"&generatedby="+generatedby+"&user_type="+user_type+"&costype="+costype, "_blank");
    });     
