$(function() {
    ...
    //  alert(user_level + '    ' + current_user + '    ' + prod_opr);
    ...
    //  }
     ...
     $('#lst-machineid, #lst_date_range, #lst-categorycode, #lst-postedby, #lst-operatedby, #lst-prodstatus, #lst-reptype, #lst-shift').on("change", function(){
        ...
        $.ajax({
             url:"ajax/prodfin_report.ajax.php",   
             method: "POST",                
             data: data,                    
             cache: false,                  
             contentType: false,            
                        ...
                        html.push('<table class="table mx-auto w-auto">');
                            html.push('<thead>');
                              html.push('<tr>');
                                ...
                                html.push('<th class="table_head_right_fixed" style="padding-top:8px;padding-bottom:8px;">Weight</th>');
                            ...
                            html.push('</thead>');
                              ...
                              for(var i = 0; i < answer.length; i++) {
                                  ...
                                  var total_weight = numberWithCommas(release.total_weight);
                                  var total_amount = numberWithCommas(release.total_amount);
                                      html.push('<tr>');
                                        ...
                                        if (i == answer.length - 1){
                                          ...
                                          html.push('<td style="font-size:1.1em;font-weight:bold;text-align:right;border-top: 2px solid white;color:orange;">'+total_weight+'</td>');
                                          ...
                                          html.push('<td style="text-align:right;color:orange;">'+total_weight+'</td>');
                        ...
                        html.push('<table class="table mx-auto w-auto">');
                            ...
                            for(var i = 0; i < answer.length; i++) {
                                ...
                                html.push('<tr>');
                                  ...
                                  // html.push('<td>'+pdesc+'</td>');
                                  if (release.prodname == null){
                                    // html.push('<td style="font-size:1.2em;font-weight:bold;text-align:right;">'+total_qty+'</td>');
                                    html.push('<td style="font-size:1.2em;font-weight:bold;text-align:right;border-top: 2px solid white;">'+total_qty+'</td>');
                                    html.push('<td style="font-size:1.2em;font-weight:bold;text-align:right;border-top: 2px solid white;color:orange;">'+total_weight+'</td>');
                      ...
                      html.push('<div class="table-responsive" style="overflow-y: auto; max-height: 470px;">');
                        html.push('<table class="table mx-auto w-auto">');
                          ...
                          html.push('<tr>');
                            ...
                            html.push('<th class="table_head_left_fixed" style="padding-top:8px;padding-bottom:8px;">Prod #</th>');
                          ...
                          for(var i = 0; i < answer.length; i++) {
                              ...
                              var prod_date = release.proddate;
                              var proddate = prod_date.substring(5, 7) + '/' + prod_date.substring(8, 10) + '/' + prod_date.substring(0, 4);
  
                              var prodnumber = release.prodnumber;
                              var machabbr = release.machabbr;
                              var machinedesc = release.machinedesc;
                              var prodstatus = release.prodstatus;
                              ...
                              var waste_damage = numberWithCommas(release.waste_damage);
                              var wd_weight = numberWithCommas(release.wd_weight);
                              ...
                              if (prodname == null){
                                ...
                                if (i == 0){
                                  var prev_prodnumber = release.prodnumber;
                                  var prev_proddate = release.proddate;
                                }else{
                                  var curr_prodnumber = release.prodnumber;
                                  ...
                                  var prev_prodnumber = curr_prodnumber;
                                  // don't display same date
                                  var curr_proddate = release.proddate;
                                  if (prev_proddate == curr_proddate){
                                    proddate = '';
                                  }
                                  var prev_proddate = curr_proddate;                    
                                }                 
                              }
  
                              html.push('<tr>');
                                html.push('<td>'+proddate+'</td>');
  
                                if (prodstatus == 'Void'){
                                  html.push('<td style="color:orange;">'+prodnumber+'</td>');
                                }else{
                                  html.push('<td>'+prodnumber+'</td>');
                                }
                        ...
                        html.push('<table class="table mx-auto w-auto">');
                            ...
                            html.push('</thead>');
                              ...
                              for(var i = 0; i < answer.length; i++) {
                                  ...
                                  var qty = numberWithCommas(release.qty);
                                  var weight = numberWithCommas(release.weight);
                                  var tamount = numberWithCommas(release.tamount);
                                  ...
                                  html.push('<tr>');
                                    ...
                                    if (prodname == null){
                                      html.push('<td style="font-size:1.2em;font-weight:bold;text-align:right;"></td>');
                                      html.push('<td style="font-size:1.2em;font-weight:bold;text-align:right;border-top: 2px solid white;color:orange;">'+weight+'</td>');
                                      html.push('<td style="font-size:1.2em;font-weight:bold;text-align:right;border-top: 2px solid white;">'+tamount+'</td>');
                                    }else{
                                      html.push('<td style="text-align:right;">'+qty+'</td>');
                                      html.push('<td style="text-align:right;color:orange;">'+weight+'</td>');
                                      html.push('<td style="text-align:right;">'+tamount+'</td>');
                                    }
                                  html.push('</tr>');   
                              }   
