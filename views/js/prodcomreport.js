$(function() {
     ...
     $("#btn-print-report").click(function(){
       ...
       window.open("extensions/tcpdf/pdf/prodcomprint.php?reptype="+reptype+"&machineid="+machineid+"&start_date="+start_date+"&end_date="+end_date+"&categorycode="+categorycode+"&postedby="+postedby+"&operatedby="+operatedby+"&prodstatus="+prodstatus+"&generatedby="+generatedby+"&user_type="+user_type, "_blank");
    });          
