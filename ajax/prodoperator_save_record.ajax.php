...
class saveProdoperator{
  ...
  public function postSaveProdoperator(){
    ...
    if ($trans_type == 'New'){
      $answer = (new ControllerProdfin)->ctrCreateProdoperator($data);
    }else{
      $answer = (new ControllerProdfin)->ctrEditProdoperator($data);
    }

  }
}

$prod_fin = new saveProdoperator();

$prod_fin -> trans_type = $_POST["trans_type"];
$prod_fin -> etype = $_POST["etype"];
