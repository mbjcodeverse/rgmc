...
class PurchaseItemsList{
	public function showPurchaseItemsList(){
		$items = (new ControllerRawMats)->ctrPurchaseItemsList();
		if(count($items) == 0){
			$jsonData = '{"data":[]}';
			echo $jsonData;
			return;
...
$listRawMats = new PurchaseItemsList();
$listRawMats -> showPurchaseItemsList();