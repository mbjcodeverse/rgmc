...
class printFinalProductionInfo{
public $reptype;
public $machineid;
public $start_date;
public $end_date;
...
public function getFinalProduction(){
  ...
  $report_content = (new ControllerProdfin)->ctrShowProdfinReport($machineid, $start_date, $end_date, $categorycode, $postedby, $operatedby, $prodstatus, $reptype, $shift);
  ...
  if ($reptype == "1"){
      ...
      <table>
          ...
          <tr>
            <td style="width:540px;text-align:center;font-size:1.2em;font-weight:bold;">OVERALL PRODUCTION CATEGORY</td> 
          </tr>
    ...
    if ($i > 0){
        ...
        <table style="border: none;"> 
          ...
          <tr>  
            ...
            <td style="width:220px;font-size:10px;">Issued by:</td>
            <td style="width:220px;font-size:10px;">Issued by:</td>
            <td style="width:155px;font-size:10px;"></td>
          </tr>
  ...
  // ----------------------------------------------------------------------------------------------------------------
    ...
    $pdf->Output('prodfinprint.pdf', 'I');
   }  // end of getFinalProduction
  }   // end of class

  $finished_goods = new printFinalProductionInfo();
  $finished_goods -> reptype = $_GET["reptype"];
  $finished_goods -> machineid = $_GET["machineid"];
  $finished_goods -> start_date = $_GET["start_date"];
  $finished_goods -> end_date = $_GET["end_date"];
  $finished_goods -> categorycode = $_GET["categorycode"];
  $finished_goods -> postedby = $_GET["postedby"];
  $finished_goods -> operatedby = $_GET["operatedby"];
  $finished_goods -> prodstatus = $_GET["prodstatus"];
  $finished_goods -> reptype = $_GET["reptype"]; 
  $finished_goods -> generatedby = $_GET["generatedby"];  
  $finished_goods -> shift = $_GET["shift"];
  $finished_goods -> getFinalProduction();
