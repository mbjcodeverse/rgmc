...
class printProductComponentsInfo{
public $reptype;
public $machineid;
public $start_date;
public $end_date;
...
public function getProductComponents(){
  ...
  $report_content = (new ControllerProdcom)->ctrShowProdcomReport($machineid, $start_date, $end_date, $categorycode, $postedby, $operatedby, $prodstatus, $reptype);
  ...
  if ($reptype == "1"){
      ...
      <table>
          ...
          <tr>
            <td style="width:540px;text-align:center;font-size:1.2em;font-weight:bold;">OVERALL SUBCOMPONENTS PRODUCTION CATEGORY</td> 
          </tr>
  ...
  // ----------------------------------------------------------------------------------------------------------------
    ...
    <table>
        ...
        <tr>
          <td style="width:730px;text-align:center;font-size:1.4em;font-weight:bold;">PRODUCTION RECEIPT</td> 
        </tr>

        <tr>
          <td style="width:730px;text-align:center;font-size:8px;;">PRODUCT CATEGORY + DESCRIPTION</td> 
        </tr>
    ...
    if ($i > 0){
        ...
        <table style="border: none;"> 
          ...
          <tr>  
            ...
            <td style="width:220px;font-size:10px;">Issued by:</td>
            <td style="width:155px;font-size:10px;">Received by:</td>
          </tr>
  ...
  // ----------------------------------------------------------------------------------------------------------------
      ...
      <table>
          ...
          <tr>
            <td style="width:950px;text-align:center;font-size:1.2em;font-weight:bold;">PRODUCTION SEQUENCE DETAILS</td> 
          </tr>
  ...
  // ----------------------------------------------------------------------------------------------------------------
    ...
    <table>
        ...
        <tr>
          <td style="width:730px;text-align:center;font-size:1.2em;font-weight:bold;">MACHINE SUBCOMPONENTS PRODUCTION SUMMATION</td> 
        </tr>
  ...
  // ----------------------------------------------------------------------------------------------------------------
    ...
    $pdf->Output('prodcomprint.pdf', 'I');
   }  // end of getProductComponents
  }   // end of class

  $subcomponents = new printProductComponentsInfo();
  $subcomponents -> reptype = $_GET["reptype"];
  $subcomponents -> machineid = $_GET["machineid"];
  $subcomponents -> start_date = $_GET["start_date"];
  $subcomponents -> end_date = $_GET["end_date"];
  $subcomponents -> categorycode = $_GET["categorycode"];
  $subcomponents -> postedby = $_GET["postedby"];
  $subcomponents -> operatedby = $_GET["operatedby"];
  $subcomponents -> prodstatus = $_GET["prodstatus"];
  $subcomponents -> reptype = $_GET["reptype"]; 
  $subcomponents -> generatedby = $_GET["generatedby"];  
  $subcomponents -> getProductComponents();
