...
public function getRawout(){
  ...
  $report_content = (new ControllerRawout)->ctrShowRawoutReport($machineid, $start_date, $end_date, $categorycode, $postedby, $requestby, $reqstatus, $reptype, $costype);
  ...
  if ($reptype == "1"){
      ...
      <table>
          ...
          <tr>
            <td style="width:540px;text-align:center;font-size:1.2em;font-weight:bold;">OVERALL REQUISITION CATEGORY</td> 
          </tr>
  ...
  // ----------------------------------------------------------------------------------------------------------------
    ...
    <table>
        ...
        <tr>
          <td style="width:730px;text-align:center;font-size:1.2em;font-weight:bold;">REQUISITION CATEGORY + DESCRIPTION</td> 
        </tr>
  ...
  // ----------------------------------------------------------------------------------------------------------------
      ...
      <table>
          ...
          <tr>
            <td style="width:950px;text-align:center;font-size:1.2em;font-weight:bold;">REQUISITION DATE SEQUENCE DETAILS</td> 
          </tr>
          ...
          <tr>       
              ...
              <td style="border: 1px solid black;width:82px;text-align:left;font-size:9px;">&nbsp; Req #</td>
    ...
    $i = 0;
    foreach ($report_content as $key => $value){
      $reqdate = substr($value["reqdate"],5,2)."/".substr($value["reqdate"],8,2)."/".substr($value["reqdate"],0,4);
      $reqnumber = $value["reqnumber"];
      ...
      if ($value["prodname"] == null){
        ...
        if ($i == 0){
          $prev_reqnumber = $value["reqnumber"];
        }else{
          $curr_reqnumber = $value["reqnumber"];
          if ($prev_reqnumber == $curr_reqnumber){
            $reqdate = '';
            $reqnumber = '';
            $machinedesc = '';
          }
          $prev_reqnumber = $curr_reqnumber;
        }                 
      }
        ...
        if ($value["prodname"] == null){
          ...
          <table style="border: none;">    
              <tr>
                  ...
                  <td style="width:82px;text-align:left;font-size:9px;">&nbsp; $reqnumber</td> 
      ...
      EOF;
          ...
          <table style="border: none;">    
              <tr>
                  <td style="width:92px;"></td> 
                  <td style="width:56px;text-align:left;font-size:9px;">$reqdate</td>    
                  <td style="width:82px;text-align:left;font-size:9px;">&nbsp; $reqnumber</td> 
                  <td style="width:170px;text-align:left;font-size:9px;">&nbsp; $machinedesc</td>   
                  <td style="width:290px;text-align:left;font-size:9px;">&nbsp; $pdesc</td>
  ...
  // ----------------------------------------------------------------------------------------------------------------
    ...
    <table>
        ...
        <tr>
          <td style="width:730px;text-align:center;font-size:1.2em;font-weight:bold;">MACHINE ITEM REQUISITION SUMMATION</td> 
        </tr>
  ...
  // ----------------------------------------------------------------------------------------------------------------
      ...
      <table>
          ...
          <tr>
            <td style="width:950px;text-align:center;font-size:1.2em;font-weight:bold;">MACHINE REQUISITION DATE TRAIL</td> 
          </tr>
  ...
  // ----------------------------------------------------------------------------------------------------------------
    ...
    $pdf->Output('rawoutprint.pdf', 'I');
   }  // end of getRawout
  }   // end of class

  $rawout_fields = new printRawoutInfo();
  $rawout_fields -> reptype = $_GET["reptype"];
  $rawout_fields -> machineid = $_GET["machineid"];
  $rawout_fields -> start_date = $_GET["start_date"];
  $rawout_fields -> end_date = $_GET["end_date"];
  $rawout_fields -> categorycode = $_GET["categorycode"];
  $rawout_fields -> postedby = $_GET["postedby"];
  $rawout_fields -> requestby = $_GET["requestby"];
  $rawout_fields -> reqstatus = $_GET["reqstatus"];
  $rawout_fields -> reptype = $_GET["reptype"]; 
  $rawout_fields -> generatedby = $_GET["generatedby"]; 
  $rawout_fields -> costype = $_GET["costype"];  
  $rawout_fields -> getRawout();
